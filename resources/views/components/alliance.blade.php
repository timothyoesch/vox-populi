@php
    $logos = collect(scandir(public_path('images/alliance/' . app()->getLocale())))->filter(function ($file) {
        ...
        return [
            ...
            'url' => asset('images/alliance/' . app()->getLocale() . "/" . pathinfo($file, PATHINFO_FILENAME)),
        ];
    })->values()->toArray();
@endphp
