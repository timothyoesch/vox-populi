...
<div class="appeal-sharebuttons grid md:grid-cols-2 gap-4">
    ...
    <a href="https://twitter.com/intent/tweet?text={{$text}}&url={{$url}}" target="_blank" class="appeal-sharebuttons__button appeal-sharebuttons__button--redirect">{{__("pages.success.shareTwitter")}}</a>
